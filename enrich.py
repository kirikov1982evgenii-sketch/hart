...
def guess_duration(cat: str, tags: list[str]) -> str:
    if cat == "interactive":
        return "Программа · 80+ часов"
    if cat == "methodology":
        return "Программа · 48+ часов"
    if "вуз" in tags or "MIT" in tags:
        return "Программа · 360+ часов"
    if "видео" in tags:
        return "Программа · 320+ часов"
    if "IT" in tags or "Python" in tags or "ML" in tags:
        return "Программа · 520+ часов"
    if cat == "courses":
        return "Программа · 320+ часов"
    return "Программа · 200+ часов"
